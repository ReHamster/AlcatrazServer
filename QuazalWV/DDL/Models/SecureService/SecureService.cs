...
namespace QuazalWV.DDL.Models
{
    ...
    {
        public static void ProcessSecureServiceRequest(Stream s, RMCPacket rmc)
        {
            switch (rmc.methodID)
            {
                case 4:
        ...
        public static void HandleSecureServiceRequest(QPacket p, RMCPacket rmc, ClientInfo client)
        {
            RMCPResponse reply;
            switch (rmc.methodID)
            {
