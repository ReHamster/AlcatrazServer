...
const char* DISCORD_APPLICATION_ID = "1009516226789265409"; // https://discordapp.com/developers/applications
...
void CDiscord::UpdatePresence()
{
	...
	discordPresence.largeImageText = "Driver San Francisco";
...
void CDiscord::SetStatus(DiscordRichPresence presence, std::string details = "", std::string state = "")
{
	std::string detailsStr = "In-Game ID: " + details;
	presence.state = state.c_str();
	presence.details = detailsStr.c_str();
	presence.largeImageKey = "background";
	presence.smallImageKey = "icon-512";
	presence.largeImageText = "Driver San Francisco";
	StartTime = time(NULL);
	presence.instance = 1;
